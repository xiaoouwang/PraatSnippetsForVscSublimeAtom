...
Remove
# excluded phonemes
exclude = Create Strings as tokens: "boyd byed bode bowed bide", " "
wl = To WordList

# 08/11/2020 Xiaoou WANG
Erase all
Font size... 18
Line width... 1
Viewport... 0 6 0 4
# Axes
# Axes... 1500 700 900 100
Axes... 2500 700 900 100
...
# text directory /Users/xiaoou/Documents/languages/todo/
...
# positive Maximum_formant_(Hz) 5000 (= adult female)
...
selectObject: wl
excluded = Has word: label$

select TextGrid 'filename$'
segment_label$ = label$
if label$ = segment_label$ and label$ <> "" and excluded = 0
	token = token + 1
	...
	measurepoint = segstart + segduration / 2

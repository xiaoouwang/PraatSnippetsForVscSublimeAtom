...
beginPause: "Calculate A1, P0, P1 & duration for labeled vowels in files"
	...
	comment: "Automaticity"
	   	choice: "autorun", 3
  	    option: "Manual (Full human control)"
  	    option: "Two-Pass (Measure, then hand-check flagged data)"
  	   	option: "Full-Auto (No Human Intervention)"
						...
						if word_label$ <> "Supercalifragilisticexpialidocious"
							...
							for point from 1 to tpnum
								...
								if hasit = 0
								    ...
								    select Sound 'soundname$'_pulses
								  margingin = 0.039
									tpslicelow = 'mtimepoint' - margingin
									tpslicehigh = 'mtimepoint' + margingin

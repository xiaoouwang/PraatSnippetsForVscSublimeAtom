# Convolution demo sawtooth / damped sine.

Erase all
lead = Create Sound from formula... null 1 0 0.0075 60000 0
period = 0.012
Create Sound from formula... p 1 0 'period' 60000 1-x/'period'
Create Sound from formula... train 1 0 0.08 60000 0
Formula... Sound_p(x mod 'period')
plus lead
Concatenate
Rename... source
Copy... mult
...
demo Text special... 50 centre 98 half Times 14 0 Convolution mechanism (2)
...
demo Text special... 0.038 left -0.11 half Times 12 0 through sawtooth wave.

demo Select inner viewport... 5 70 32 57
demo One mark left... 0 yes yes no
demo One mark left... -1 yes yes no 
demo One mark left... 1 yes yes no 
demo One mark right... -1 no yes no  -0.02
demo One mark right... 1 no yes no  0.02
...
demo One mark left... -1 no yes no -0.02
demo One mark left... 1 no yes no 0.02
...
for step to nsteps
   ...
   if step < nsteps
      demo White
      call drawStep
      demo Paint rectangle... White 0.0351 0.037 -0.1 0.945
      demo Black
   endif
